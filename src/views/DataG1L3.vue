<template>
  ...
  <div class="px-4 py-6 shadow-lg shadow-blue-100">
    ...
    <p class="mt-4 font-medium">R. Perpustakaan</p>
  ...
  <div class="px-4 py-6 shadow-lg shadow-blue-100">
    ...
    <p class="mt-4 font-medium">R. TPBK</p>
    <p class="mt-2 text-xl font-medium"> 
...
<div class="m-10 grid gap-5 sm:grid-cols-3  mx-auto max-w-screen-lg">
  <div class="px-4 py-6 shadow-lg shadow-blue-100">
    ...
    <p class="mt-4 font-medium">R. Dosen 2</p>
    <p class="mt-2 text-xl font-medium">
  ...
  <div class="px-4 py-6 shadow-lg shadow-blue-100">
    ...
    <p class="mt-4 font-medium">R. Konseling</p>
    <p class="mt-2 text-xl font-medium">
...
<div class="m-10 grid gap-5 sm:grid-cols-3 mx-auto max-w-screen-lg mt-20">
  ...
  <div class="px-4 py-6 shadow-lg shadow-blue-100">
    ...
    <p class="mt-4 font-medium">Toilet</p>
    <p class="mt-2 text-xl font-medium">
